...
export const specGroups: SpecGroup[] = [
  ...
  {
    label: "Backend",
    items: ["NestJS", "Express", "Laravel", "Node.js"],
  },
  {
    label: "Databases",
    items: ["PostgreSQL", "MySQL", "Redis", "Prisma", "Drizzle ORM"],
  },
  {
    label: "Messaging & Queues",
    items: ["RabbitMQ", "BullMQ", "Apache Kafka"],
  },
  {
    label: "API & Security",
    items: ["REST", "Swagger", "JWT", "RBAC", "Helmet", "Rate Limiting"],
  },
  { label: "Frontend", items: ["React"] },
  { label: "Testing", items: ["Unit", "Integration"] },
  {
    label: "Tools & Infra",
    items: ["Docker", "Linux", "Git", "CI/CD", "Podman"],
  },
];

...
export function WhatsappIcon({ size = 18 }: IconProps) {
  return (
    <svg width={size} height={size} viewBox="0 0 24 24" fill="currentColor" aria-hidden="true">
      <path d="M12.04 2a9.9 9.9 0 0 0-8.5 14.96L2 22l5.18-1.5A9.9 9.9 0 1 0 12.04 2zm5.84 14.02c-.25.7-1.44 1.34-2.02 1.39-.55.05-1.24.24-4.18-1.06-3.53-1.57-5.79-5.45-5.97-5.7-.17-.25-1.43-1.9-1.43-3.63 0-1.73.91-2.58 1.23-2.93.32-.35.7-.44.94-.44h.67c.22 0 .51-.08.79.6.29.7.98 2.4 1.06 2.58.09.17.15.38.03.61-.12.24-.18.38-.36.59-.18.2-.38.46-.54.61-.18.18-.37.37-.16.73.21.35.94 1.54 2.01 2.5 1.38 1.23 2.54 1.61 2.9 1.79.36.18.57.15.78-.09.21-.24.9-1.04 1.14-1.4.24-.35.48-.3.8-.18.33.12 2.07.98 2.43 1.16.36.18.59.27.68.42.09.15.09.87-.16 1.57z" />
    </svg>
  )
}
...
export function RadioIcon({ size = 18 }: IconProps) {
  return (
    <svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round" aria-hidden="true">
...
export function LayoutIcon({ size = 18 }: IconProps) {
  return (
    <svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round" aria-hidden="true">
...
export function FlaskIcon({ size = 18 }: IconProps) {
  return (
    <svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round" aria-hidden="true">
      <path d="M10 2v6L4.5 18a2 2 0 0 0 1.76 3h11.48a2 2 0 0 0 1.76-3L14 8V2" />
      <path d="M8.5 2h7" />
      <path d="M7 15h10" />
    </svg>
  )
